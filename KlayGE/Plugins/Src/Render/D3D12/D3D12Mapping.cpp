...
namespace KlayGE
{
	...
	/////////////////////////////////////////////////////////////////////////////////
	D3D11_COMPARISON_FUNC D3D12Mapping::Mapping(CompareFunction func)
	{
		switch (func)
		{
		case CF_AlwaysFail:
	...
	/////////////////////////////////////////////////////////////////////////////////
	D3D11_STENCIL_OP D3D12Mapping::Mapping(StencilOperation op)
	{
		switch (op)
		{
		case SOP_Keep:
	...
	D3D11_MAP D3D12Mapping::Mapping(TextureMapAccess tma, Texture::TextureType type, uint32_t access_hint, uint32_t numMipMaps)
	{
		switch (tma)
		{
		case TMA_Read_Only:
	...
	D3D11_BLEND D3D12Mapping::Mapping(AlphaBlendFactor factor)
	{
		switch (factor)
		{
		case ABF_Zero:
	...
	D3D11_CULL_MODE D3D12Mapping::Mapping(CullMode mode)
	{
		switch (mode)
		{
		case CM_None:
	...
	D3D11_FILL_MODE D3D12Mapping::Mapping(PolygonMode mode)
	{
		switch (mode)
		{
		case PM_Point:
	...
	D3D11_BLEND_OP D3D12Mapping::Mapping(BlendOperation bo)
	{
		switch (bo)
		{
		case BOP_Add:
	...
	D3D11_TEXTURE_ADDRESS_MODE D3D12Mapping::Mapping(TexAddressingMode mode)
	{
		switch (mode)
		{
		case TAM_Clamp:
	...
	D3D11_FILTER D3D12Mapping::Mapping(TexFilterOp filter)
	{
		switch (filter)
		{
	...
	D3D11_DEPTH_WRITE_MASK D3D12Mapping::Mapping(bool depth_write_mask)
	{
		if (depth_write_mask)
		{
	...
	D3D11_LOGIC_OP D3D12Mapping::Mapping(LogicOperation lo)
	{
		switch (lo)
		{
		case LOP_Clear:
	...
	D3D11_PRIMITIVE_TOPOLOGY D3D12Mapping::Mapping(RenderLayout::topology_type tt)
	{
		switch (tt)
		{
	...
	void D3D12Mapping::Mapping(std::vector<D3D11_INPUT_ELEMENT_DESC>& elements, size_t stream, vertex_elements_type const & vet, RenderLayout::stream_type type, uint32_t freq)
	{
	...
	D3D11_SO_DECLARATION_ENTRY D3D12Mapping::Mapping(ShaderDesc::StreamOutputDecl const & decl, uint8_t slot)
	{
